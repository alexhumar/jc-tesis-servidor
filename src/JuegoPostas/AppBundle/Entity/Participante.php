...
class Participante {
	...
	/**
	 *
	 * @var string @ORM\Column(name="nombre", type="string", length=150, nullable=false)
	 */
	private $nombre;
	
	/**
	 *
	 * @var integer @ORM\Column(name="edad", type="integer", nullable=false)
	 */
	private $edad;
	
	/**
	 *
	 * @var \JuegoPostas\AppBundle\Entity\Subgrupo @ORM\ManyToOne(targetEntity="JuegoPostas\AppBundle\Entity\Subgrupo", inversedBy="participantes")
	 *      @ORM\JoinColumns({
