...
class Subgrupo {
	...
	/**
	 *
	 * @var string @ORM\Column(name="nombre", type="string", length=100, nullable=false, unique=true)
	 */
	private $nombre;
	
	/**
	 *
	 * @var \JuegoPostas\AppBundle\Entity\EstadoSubgrupo @ORM\ManyToOne(targetEntity="JuegoPostas\AppBundle\Entity\EstadoSubgrupo")
	 *      @ORM\JoinColumns({
	...
	/**
	 *
	 * @var \JuegoPostas\AppBundle\Entity\Grupo @ORM\ManyToOne(targetEntity="JuegoPostas\AppBundle\Entity\Grupo")
	 *      @ORM\JoinColumns({
