...
class Grupo
{
    ...
    /**
     * @var \JuegoPostas\AppBundle\Entity\Camino
     *
     * @ORM\ManyToOne(targetEntity="JuegoPostas\AppBundle\Entity\Camino")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \JuegoPostas\AppBundle\Entity\Consigna
     *
     * @ORM\ManyToOne(targetEntity="JuegoPostas\AppBundle\Entity\Consigna")
     * @ORM\JoinColumns({
