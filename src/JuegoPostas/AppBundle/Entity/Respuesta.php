...
class Respuesta {
	...
	/**
	 *
	 * @var boolean @ORM\Column(name="acuerdo_propuesta", type="boolean", nullable=false)
	 */
	private $acuerdoPropuesta;
	
	/**
	 *
	 * @var string @ORM\Column(name="justificacion", type="string", length=255, nullable=false)
	 */
	private $justificacion;
	
	/**
	 *
	 * @var \JuegoPostas\AppBundle\Entity\Consulta @ORM\ManyToOne(targetEntity="JuegoPostas\AppBundle\Entity\Consulta")
	 *      @ORM\JoinColumns({
	...
	/**
	 *
	 * @var \JuegoPostas\AppBundle\Entity\Subgrupo @ORM\ManyToOne(targetEntity="JuegoPostas\AppBundle\Entity\Subgrupo")
	 *      @ORM\JoinColumns({
